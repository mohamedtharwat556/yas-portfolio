...
const HeroRotatingText = (() => {
    const phrases = ['Die einen Unterschied machen', 'Für 500+ Institutionen', 'Geräte · Lösungen · Wartung', 'Ihr vertrauenswürdiger Partner', 'Schnelle Lieferung', '25 Jahre Erfahrung', 'Kontinuierlicher Support', 'Qualität ohne Kompromisse'];
        ...
        const opt = {
            ...
            html2canvas: {
                ...
                onclone: (clonedDoc) => {
                    ...
                    clonedDoc.documentElement.setAttribute('lang', 'de');
